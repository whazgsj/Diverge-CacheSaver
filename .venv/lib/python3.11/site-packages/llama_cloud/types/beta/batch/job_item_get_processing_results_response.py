...
class ProcessingResultJobConfigBatchParseJobRecordCreate(BaseModel):
    ...
    job_name: Optional[Literal["parse_raw_file_job"]] = None

    parameters: Optional[ProcessingResultJobConfigBatchParseJobRecordCreateParameters] = None
    """Generic parse job configuration for batch processing.
...
ProcessingResultJobConfig: TypeAlias = Union[ProcessingResultJobConfigBatchParseJobRecordCreate, ClassifyJob]
...
class ProcessingResult(BaseModel):
    ...
    output_metadata: Optional[object] = None
